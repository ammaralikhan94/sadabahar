    ...
    <body>
        ...
        <div class="wrapper-page login">
            ...
            <div class="panel-heading"> 
                <h3 class="text-center text-white"> Sign In to <strong class="text-custom">Sadabahar</strong> </h3>
            </div> 
            ...
            <form class="form-horizontal m-t-20" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <div class="checkbox checkbox-primary">
                            ...
                            <label for="checkbox-signup text-white">
                                Remember me
                            </label>
                        </div>
                ...
                <div class="form-group m-t-30 m-b-0">
                    <div class="col-sm-12">
                        <a href="page-recoverpw.html" class="text-white forgot-pass"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                    </div>
                </div>
            </form> 
