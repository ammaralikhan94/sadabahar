                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" action="{{route('update_inventory')}}" method="post">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-3">
                                    <input type="number" class="form-control amount" value="{{$inventory->chemical_amount}}" name="chemical_amount" id="chemical_amount" placeholder="Item amount"  required="" readonly="">
                                </div>
                                <label class="col-md-3 control-label">Quantity</label>
                                <div class="col-md-3">
                                     <input type="number" class="form-control quantity" value="{{$inventory->quantity}}" name="quantity" id="barrel_amount" placeholder="barrel amount"  required="" value="1" readonly="">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" required="" name="supplier" readonly="">
                            ...
                            <div class="form-group col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">                                    
                                         <input type="text" class="form-control"  value="{{$inventory->get_chemical['chemical_name']}}"  required="" readonly="">
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" class="form-control" name="chemical_name" value="{{$inventory->chemical_name}}"  required="" readonly="">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6 due" style="display: none">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" name="due_amount"  value="{{$inventory->due_amount}}">
                                </div>
                            </div>
