                    ...
                    <div class="col-md-12">
                           ...
                           <div class="col-md-6">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="supplier_invoice_number" value="{{$inventory[0]->supplier_invoice_number}}" id="supinvoice" placeholder="Supplier Invoice Number"  required="" >
                                    </div>                                
                                </div>
                                <div class="form-group col-md-6">
                                    <!-- <label class="col-md-3 control-label">Name</label> -->
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="supplier_invoice_date" value="{{$inventory[0]->supplier_invoice_date}}" id="invoice_date" placeholder="Dated"  required="" >
                                    </div>                                
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <!-- <label class="col-md-4 control-label">Scode</label> -->
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="supplier_order_number" value="{{$inventory[0]->supplier_order_number}}" id="purchase-order" placeholder="Purchase Order Number"  required="" >
                                    </div>                                
                                </div>
                                <div class="form-group col-md-6">
                                    <!-- <label class="col-md-3 control-label">Name</label> -->
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="supplier_order_date" value="{{$inventory[0]->supplier_order_date}}" id="order_date" placeholder="Dated"  required="" >
                                    </div>                                
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card-box clearfix">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <input type="number" class="form-control amount" name="net_total" id="net_total" placeholder="Balance" value="{{$val->net_total}}" required="">
                                        </div>                                
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <div class="form-group col-md-12 credit_amount_field"  @php echo ($val->payment_credit == 'on')?'':'style="display: none"'@endphp >
                                    ...
                                    <div class="form-group col-md-12 credit_amount_field"  @php echo ($val->credit_date_limit == 'on')?'':'style="display: none"'@endphp>
                                    ...
                                    <div class="form-group col-md-12" id="cash_recieved"  {{($val->cash_recieved == 'on')?'':'style="display: none"'}} >
                                        <label class="col-md-5 control-label">Cash Recieved</label>
                                        <div class="col-md-7">
                                            <input type="number" class="form-control amount"  name="cash_recieved" value="{{$val->cash_recieved}}" id="cash_recieved" placeholder="Cash Recieved"  >
                                        </div>                                  
                                    </div>
                                    {{-- *************************POST DATE CHEQUE ************************ --}}
