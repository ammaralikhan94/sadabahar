                    ...
                    <div class="col-md-12">     
                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">                                    
                                        <select class="form-control" name="chemical_name" required="">
                                                ...
                                                @foreach($chemical as $key => $val)
                                                    <option value="{{$val->id}}" {{($inventory->chemical_name == $val->id)?'selected':''}}>{{$val->chemical_name}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-6">
                                     <select class="form-control" name="purchase_unit">
                                         ...
                                         <option value="kg" {{($inventory->purchase_unit == 'kg')?'selected':''}}>Kg</option>
                                         <option value="liter" {{($inventory->purchase_unit == 'liter')?'selected':''}}>Liter</option>
                                         <option value="gram" {{($inventory->purchase_unit == 'gram')?'selected':''}}>Gram</option>
                                         <option value="quantity" {{($inventory->purchase_unit == 'quantity')?'selected':''}}>Quantity</option>
                                     </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 unit_purchased">
                                ...
                                <div class="col-md-6 ">
                                    <input type="number" class="form-control" name="unit_purchased" value="{{($inventory->purchase_unit =='kg')?'':$inventory->unit_purchased}}" placeholder="Enter Unit Purchased"  >
                                </div>
                            </div>
                            ...
                            <input type="hidden" id="check_purchased" value="{{$inventory->purchased_kg}}">
                            ...
                            <div class="col-md-4 purchased_gram" style="display: none;">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="purchased_gram" placeholder="Enter kg"> 
                                            <option value="0" {{($inventory->purchased_gram == '0' )?'selected':''}}>None</option>
                                            <option value="500" {{($inventory->purchased_gram == '500' )?'selected':''}}>500 gram</option>
                                            <option value="250" {{($inventory->purchased_gram == '250' )?'selected':''}}>250 gram</option>
                                            <option value="750" {{($inventory->purchased_gram == '750' )?'selected':''}}>750 gram</option>
                                            <option value="1000" {{($inventory->purchased_gram == '1000' )?'selected':''}}>1000 gram</option>
                                    </select>
                                </div>
                            </div> 
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-6">
                                     <input type="number" class="form-control quantity" name="quantity" id="barrel_amount" placeholder="barrel amount"  required="" value="{{$inventory->quantity}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control amount" name="chemical_amount" id="chemical_amount" placeholder="Item amount"  required="" value="{{$inventory->chemical_amount}}">
                                </div>                                
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="total_amount" value="{{$inventory->total_amount}}" id="total_amount" placeholder="amount"  required="" readonly="">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div class="checkbox checkbox-warning" style="float: left; margin-right:5px;">
                                        <input  name="payment_cash" type="checkbox"  value="1" {{($inventory->payment_cash == 1)?'checked':''}}>
                                        <label for="checkbox5">
                                            Cash
                                        </label>
                                     </div>
                                    <div class="checkbox checkbox-warning" style="float: left; margin-right:5px;">
                                        <input  type="checkbox" name="payment_credit"  value="1" {{($inventory->payment_credit == 1)?'checked':''}}>
                                        <label for="checkbox5">
                                             Credit amount
                                        </label>
                                    </div>
                                    <div class="checkbox checkbox-warning" style="float: left; margin-right:5px;">
                                        <input  type="checkbox"  name="payment_cheque" id="pdc" value="1" {{($inventory->payment_cheque == 1)?'checked':''}}>
                                        <label for="checkbox5">
                                            Post-dated cheque
                                        </label>
                                    </div>
                            ...
                            <div class="form-group col-md-4" style="display: none;" id="credit_amount">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" name="limit_amount" value="{{$inventory->limit_amount}}" placeholder="amount" >
                            ...
                            <div class="form-group col-md-4 cash"  style="display: none">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" name="cash_recieved" value="{{$inventory->cash_recieved}}" placeholder="Amount recieved" >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 show_post_cheques" style="display: none">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" value="{{$inventory->cheque_amount}}"  name="cheque_amount"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 show_post_cheques" style="display: none">
                                ...
                                <div class="col-md-6">
                                    <input type="date" class="form-control" value="{{$inventory->limit_cheque_date}}" name="limit_cheque_date" min="@php echo date('Y-m-d'); @endphp"  id="limit_cheque_date"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" required="" name="payment_status" id="payment_status">
                                        ...
                                        <option value="cleared" {{($inventory->payment_status == 'cleared')?'selected':''}}>cleared</option>
                            ...
                            <div class="form-group col-md-4 due" style="display: none">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" value="{{$inventory->due_amount}}" name="due_amount"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4" style="display: none;" id="credit_amount">
                                <label class="col-md-6 control-label">Credit Amount</label>
                                <div class="col-md-6">
                                    <input type="number" class="form-control" value="{{$inventory->limit_amount}}" name="limit_amount" placeholder="amount" >
                                    <p><strong>Credit limit for this supplier is <span id="credit_limit" style="color: red"></span></strong></p>
                                </div>
                            </div>    
...
@section('customScript')
    <script type="text/javascript">
        ...
        /*On ready*/
        $(document).ready(function (){
            option = $('[name="payment_credit"]').val();
            /*$("select[name='payment_status']").find("option[value='due']").attr("selected",true);
                $('.due').show('slow');
                $('[name="due_date"]').prop('required',true);
                $('[name="due_amount"]').prop('required',true);*/
        ...
        /*On ready */
        $(document).ready(function (){
            option = $('[name="payment_cheque"]').val();
           /* $("select[name='payment_status']").find("option[value='due']").attr("selected",true);
            $('.due').show('slow');
            $('[name="due_date"]').prop('required',true);
            $('[name="due_amount"]').prop('required',true);*/
          ...
          /*On ready purchase unit */
            ...
            if(purchase_unit == 'kg'){
                ...
                for(var i = 1;i<=total_strength;i++){
                    $('[name="purchased_kg"]').append(`<option value="`+i+`" <?php echo ($inventory->unit_purchased == "'+i+'" )?'selected':''?>>`+i+` kg</option>`);
                }
            }else{
                $('.unit_purchased').show();
                $('.purchased_kg').hide();
