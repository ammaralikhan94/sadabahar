        ...
        <div class="card-box table-responsive">
            ...
            <table id="subadmin_table" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>{{$val->address}}</td>
                    <td><a class="btn btn-primary" href="{{route('edit_supplier' , ['id' => $val->id])}}">Edit</a> <a class="btn btn-primary" href="{{route('supplier_payment' , ['id' => $val->id])}}">Payment Detail</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
